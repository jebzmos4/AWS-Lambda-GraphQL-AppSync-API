...
/**
 * This function takes strings of enviroment varaiables
 * and converts them to and array
*/
const arrayGenerator = function arrayGenerator(params) {
  const response = params.split(',');
  return response;
};
